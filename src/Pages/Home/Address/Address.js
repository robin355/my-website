...
import { BsFillTelephoneFill, BsLinkedin, BsFacebook } from 'react-icons/bs';

import './Address.css'
const Address = () => {
    return (
        <div>
            <div className="footer grid lg:grid-cols-3 grid-cols-1 p-10 text-base-content footer-section">
                <div>
                    ...
                    <div className='flex gap-3 mt-3'>
                        <div className='text-2xl text-[#0d6efd]'>
                            <a href="https://www.linkedin.com/in/robin-mia-a5ba8a174" target='_blank'> <BsLinkedin></BsLinkedin></a>
                        </div>
                        <div className='text-2xl text-[#0d6efd]'>
                            <a href="https://www.facebook.com/robin3555" target='_blank'><BsFacebook></BsFacebook></a>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div className='flex justify-center items-center gap-2 '>
                        ...
                        <div>
                            <h2 className='text-base'>18/5 Ring Road, <br />Mohammadpur, Dhaka</h2>
                        </div>
                    </div>
                    <div className='flex justify-center items-center gap-2'>
                        <div className='text-[#0d6efd] text-xl'>
                ...
                <div>
                    <span className="footer-title">USA Address</span>
                    <div className='flex justify-center items-center gap-2 '>
                        <div className='text-[#0d6efd] text-xl'>
                            <MdLocationOn></MdLocationOn>
                        </div>
                        <div>
                            <h2 className='text-base'>1903 commonwealth st,<br />Houston tx 77006</h2>
                        </div>
                    </div>
                    <div className='flex justify-center items-center gap-2'>
                        <div className='text-[#0d6efd] text-xl'>
